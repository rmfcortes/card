...
export class PrimeraComponent implements OnInit {
  ...
  setColores(): void {
    ...
    for (const i of iconos) {
      ...
      i.style.setProperty('--background-activated',  `mix(#fff, #2DA830, 0.5)`)
      ...
      i.style.setProperty('--background-hover', `mix(#fff, #2DA830, 0.5)`)
      i.style.setProperty('--background-hover-opacity', 0.2)
    }

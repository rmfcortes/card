...
export class MapaPage implements OnInit {
  ...
  goMaps() {
    ...
    console.log(dir);
    const pag = `https://www.google.com/maps/place/?g=${this.perfil.ubicacion.lat},${this.perfil.ubicacion.lng}=${this.perfil.ubicacion.lat},${this.perfil.ubicacion.lng},20z`
    console.log(pag);

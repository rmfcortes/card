...
export class MapaPage implements OnInit {
  ...
  goMaps() {
    const pag = `https://www.google.com/maps/place/?g=${this.perfil.ubicacion.lat},${this.perfil.ubicacion.lng}=${this.perfil.ubicacion.lat},${this.perfil.ubicacion.lng},16z`
    console.log(pag);
    this.inAppBrowser.create(pag, '_blank');
  }
